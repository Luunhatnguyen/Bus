             ...
             <div className="comment" >
                    ...
                    <div className="comment-inner" style={{textAlign:"left"}}>
                        <div className="comment-info clearfix">
                            ...
                            Post date <Moment  format="DD/MM/YYYY">{item.updated_date}
                            </Moment>{" "}</span>
                            <div className="material-icons-wrapper md-16" style={{fontSize:"20px",minWidth:"376px",paddingLeft:"7px"}}>
                    <GoVerified className="color--positive" />
                    <p className="gJvXJw color--positive" style={{marginTop:"3px", fontSize:"15px"}}>Already bought tickets</p>
                  </div>
                        </div>
                        ...
                        <div className="author-comment">
                            <span>Commented by:</span> {item.user.first_name} {item.user.last_name}
                        </div>
  ...
  function Paginate(props) {
    ...
    return(
      ...
      {page.map(p => (
        ...
        <Pagination.Next onClick={() => props.onPageChange(props.pageCount-1)}/>
      </Pagination>
    )
  }
  ...
  return (
    <div style={{ padding: "10px" }}>
      ...
      <div
        ...
        style={{ display: "block" }}
      >
       <h2  style={{ textAlign: "left",margin: "20px 0px 0px 0px" ,paddingLeft:"7px"}}>Rating</h2>
        ...
        <div className="comment-box">
            ...
            onChange={(evt) => setContentState(evt.target.value)}/>
                                            ...
                                            <div className="col-lg-12 col-md-12 col-sm-12  message-btn">
                                                {isBooking == true ? <button className="theme-btn" onClick={addComment}>
            <IoIosPaperPlane />
            &nbsp;Send
          </button>:<button className="theme-btn"style={{cursor: "not-allowed"}}>
            <IoIosPaperPlane />
            &nbsp;Send
          </button>}
          <span
          ...
          >
            Please enter the comment
                                    ...
                                    <div className="group-title">
                                        <h2 style={{ textAlign: "left",margin: "20px 0px 0px 0px" ,paddingLeft:"7px"}}>Bình luận</h2>
                                    </div>
